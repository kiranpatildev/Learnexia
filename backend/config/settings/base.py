"""
Django settings for premium_edu_platform project.
...
INSTALLED_APPS = [
    ...
    'django_filters',
    'drf_yasg',
    # 'django_celery_beat',  # Uncomment when Celery is installed
    # 'django_celery_results',  # Uncomment when Celery is installed
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@premiumedu.com')
